...
!function($) {
	...
	// BUTTON DATA-API
	// ===============
	$(document).on('click.bs.button.data-api_1_0', '[data-toggle^="button"]',
	function(e) {
		var $btn = $(e.target);
		if (!$btn.hasClass('btn'));
		$btn = $btn.closest('.btn');
		...
		e.preventDefault();
	}).on('focus.bs.button.data-api_1_0 blur.bs.button.data-api_1_0', '[data-toggle^="button"]',
	function(e) {
...
!function($) {
	...
	// MODAL DATA-API
	// ==============
	$(document).on('click.bs.modal.data-api_1_0', '[data-toggle="modal"]',
	function(e) {
		var $this = $(this);
...
!function($) {
	...
	$(document).on('click.bs.dropdown.data-api_1_0', clearMenus).on('click.bs.dropdown.data-api_1_0', '.dropdown form',
	function(e) {
		e.stopPropagation()
	}).on('click.bs.dropdown.data-api_1_0', toggle, Dropdown.prototype.toggle).on('keydown.bs.dropdown.data-api_1_0', toggle, Dropdown.prototype.keydown).on('keydown.bs.dropdown.data-api_1_0', '.dropdown-menu', Dropdown.prototype.keydown);
} (window.jQuery);
$(function() {
	/*下拉菜单*/
...
! (function(factory) {
	...
	*/
	...
	$(document).on('focus.datetimepicker.data-api_1_0 click.datetimepicker.data-api_1_0', '[data-provide="datetimepicker"]',
	function(e) {
		var $this = $(this);

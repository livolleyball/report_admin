...
msgstr "Nedá sa pracovať s prázdnymi adresármi"
...
msgstr[0] "Minimálne %(num)d položka je povinná"
msgstr[1] "Minimálne %(num)d položka je povinná"
msgstr[2] "Minimálne %(num)d položky sú povinné"
...
msgstr "Tablib závislosti nie sú nainštalované."

#: ../flask_admin/model/base.py:2249
#, python-format
msgid "Export type \"%(type)s not supported."
msgstr "Typ exportu \"%(type)s nie je podporovaný."

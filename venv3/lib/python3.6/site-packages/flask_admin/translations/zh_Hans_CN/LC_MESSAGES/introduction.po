...
"/Fadmin/Flask-Admin/tree/master/examples/auth-flask-login."
msgstr ""
"在导航菜单中，不会显示该用户无法访问的组件。有关使用 Flask-Login 与 Flask-Admin 的示例，请参考 "
"https://github.com/Fadmin/Flask-Admin/tree/master/examples/auth-"
"flask-login。"
...
"look at https://github.com/Fadmin/Flask-"
...
msgid ""
"Have a look at the `layout` example at https://github.com/Fadmin"
"/Fadmin/tree/master/examples/layout to see how you can take full "

...
msgstr "Невозможно редактировать непустые директории"
...
msgstr[2] "Было удалено %(count)s записей."
...
msgstr "Экспорт в формате %(type)s не поддерживается."
...
msgstr "Пожалуйста, выберите модель"
